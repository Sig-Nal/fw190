...
### check fuel state for reserve light and 
			...
			if (getprop ("consumables/fuel/tank[0]/level-norm") < 0.25 ) {
...
### check fuel state for half light and 

			if (getprop ("consumables/fuel/tank[0]/level-norm") < 0.5 ) {
					setprop ("consumables/fuel/on-half", 1);
			} else {
					if (getprop ("consumables/fuel/on-half") == 1 ) {
							setprop ("consumables/fuel/on-half", 0);
					}
			}
			if (getprop ("consumables/fuel/tank[1]/level-norm") < 0.1 and ("consumables/fuel/tank[1]/selected") == 1 ) {
					setprop ("consumables/fuel/tank[1]/selected", 0 );
